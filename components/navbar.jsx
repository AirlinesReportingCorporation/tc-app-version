              ...
              <div className={styles["tc2021-nav"] + " d-lg-flex d-md-flex flex-row align-items-center"}>
                <Link className={styles["tc2021-underline"] + " d-block"} href="/">
                  <Image
                    width={225}
                    height={0}
                    className={styles["tc2021-logo"]}
                    src="https://arctravelconnect.com/globalassets/Home2/2021/TCVS-LOGO.svg"
                    alt="Travel Connect Virtual Series"
                    style={{height: "auto"}}
                  />
                </Link>
                <Link className={styles["tc-nav-link"]} href="/episodes">Episodes</Link>
                <Link className={styles["tc-nav-link"]} href="/episodes?filter=data-and-trends">
                  Data & Trends
                </Link>
                <Link className={styles["tc-nav-link"]} href="/episodes?filter=retailing">Retailing</Link>
                <Link className={styles["tc-nav-link"]} href="/episodes?filter=innovation">Innovation</Link>
                <div className={styles["arc-logo"] + " ml-lg-auto ml-md-auto d-sm-block"}>
